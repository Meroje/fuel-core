...
class Fieldset
{
	...
	public static function forge($name = 'default', array $config = array())
	{
		...
		{
			\ApplicationError::notice('Fieldset with this name exists already, cannot be overwritten.');
			return $exists;
		}
	...
	public function add($name, $label = '', array $attributes = array(), array $rules = array())
	{
		...
		{
			\ApplicationError::notice('Field with this name exists already in this fieldset: "'.$name.'".');
			return $field;
		}
